...
void menu_tmc_current() {
  ...
  #endif
  #if AXIS_IS_TMC(I) // This line checks if the I axis has a TMC driver
    TMC_EDIT_STORED_I_RMS(I, STR_I); // This line adds a menu item for the I axis
  #endif
  END_MENU();
}
  ...
  void menu_tmc_step_mode() {
    ...
    TERN_(I_HAS_STEALTHCHOP, TMC_EDIT_STEP_MODE(I, STR_I));
    END_MENU();
  }
